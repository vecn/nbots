#ifndef __VCN_MODEL2D_H__
#define __VCN_MODEL2D_H__
...
extern "C" {
	...
	/**
	 * @brief Create model from input data.
	 * @param[in] vertices Concatenated coordinates of the vertices
	 * forming the model.
	 * @param[in] N_vertices Number of vertices.
	 * @param[in] segments Concatenated pairs of vertices ids (C-numbering style),
	 * each one defining a segment.
	 * @param[in] N_segments Number of segments.
	 * @param[in] holes Concatenated coordinates of points located inside holes.
	 * Each hole should have at least one hole-indicator point.
