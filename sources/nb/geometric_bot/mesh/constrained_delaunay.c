...
static void set_constraints(nb_tessellator2D_t *mesh,
			    const uint32_t *const input_sgm,
			    uint32_t N_input_sgm);
static void set_new_constraining_sgm(nb_tessellator2D_t *mesh,
				     const msh_vtx_t *const v1,
				     const msh_vtx_t *const v2,
				     uint32_t sgm_id);
static void remove_trg_intersecting_sgm(nb_tessellator2D_t *mesh,
					const msh_vtx_t *const v1,
					const msh_vtx_t *const v2,
...
static bool trg_is_constrained(const nb_tessellator2D_t *const mesh,
			       const msh_vtx_t *const trg_v1, 
			       const msh_vtx_t *const trg_v2,
			       const msh_vtx_t *const trg_v3,
			       const nb_container_t *const vertices);
static void link_constraining_sgm(msh_edge_t *sgm);
static bool are_intersecting_edges(const nb_tessellator2D_t *const mesh,
				   const msh_vtx_t *const v1, 
				   const msh_vtx_t *const v2);
...
static bool trg_is_constrained(const nb_tessellator2D_t *const restrict mesh,
			       const msh_vtx_t *const restrict trg_v1, 
			       const msh_vtx_t *const restrict trg_v2,
			       const msh_vtx_t *const restrict trg_v3,
			       const nb_container_t *const restrict vertices)
...
static bool are_intersecting_edges(const nb_tessellator2D_t *const restrict mesh,
