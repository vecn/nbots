...
void nb_graphics_eps_export_context(void *ctx, const char *filename);

void nb_graphics_eps_move_to(void *ctx, double x, double y);

void nb_graphics_eps_line_to(void *ctx, double x, double y);
...
void nb_graphics_eps_set_rectangle(void *ctx, double x1, double y1,
				   double x2, double y2);

void nb_graphics_eps_close_path(void *ctx);

void nb_graphics_eps_set_line_width(void *ctx, double w);
...
void nb_graphics_eps_get_text_attr(void *ctx, const char *label,
				   nb_text_attr_t *attr);
