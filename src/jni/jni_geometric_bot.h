...
#ifndef _JNI_VCN_GEOMETRIC_BOT_
#define _JNI_VCN_GEOMETRIC_BOT_
...
extern "C" {
  ...
  JNIEXPORT jint JNICALL Java_mx_cimat_vcn_GeometricBot_JNICreateMesh__I_3FI_3II_3FLjava_lang_String_2IIFFFFZZZZZ_3_3F_3_3I_3_3I_3_3I_3_3I_3_3_3I
  (JNIEnv *env, jclass class,
   jint N, jfloatArray vertices,
   jint M, jintArray edges,
   jint H, jfloatArray holes,
